<html>
    <head>
        <title>официальный сайт ЧП фаворит 3</title>
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-ex-collapse">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li><a href="https://webmail.adm.tools">Почта</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
       ...
       <!--contact panel-->
        ...
        <div class="container contactTitle" style="background-color: rgba(220, 220,220, 0.8);">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-12">
                    тел. <img src="image/teh/vodafon.jpg" width="15" height="15"> 095 228 10 55
                </div>
